# doubao-seedream-5.0-lite 多图融合 API文档

将多张输入图片融合生成新图，适用于人物换装、场景合成、风格混合等场景。
...
- **参考图数量上限更多**：5.0-lite 最多支持 14 张参考图，4.5 最多 10 张
- **参考图宽高比范围更宽**：5.0-lite 支持 [1/16, 16]，4.5 仅支持 [1/3, 3]
:::
