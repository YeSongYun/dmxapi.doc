# Agnes Video V2.0 文生视频 API 文档

Agnes Video V2.0 是面向生产场景的视频生成模型，支持文生视频、图生视频和关键帧动画。采用异步任务模式：先提交任务创建视频生成请求，再通过任务 ID 查询获取视频结果。
...
"""
┌─────────────────────────────────────────────────────────────────┐
│  Agnes Video V2.0 文生视频 API 调用示例 - 提交任务                 │
│                                                                 │
│  功能说明：根据文字提示词提交视频生成任务，返回任务 ID              │
└─────────────────────────────────────────────────────────────────┘
"""
...
响应内容:
{
  "id": "task_eWgIuBLlp8rRB9j7JKlptfe45e8tzz6k",
  "task_id": "task_eWgIuBLlp8rRB9j7JKlptfe45e8tzz6k",
  "object": "video",
  "model": "agnes-video-v2.0",
  "status": "queued",
  "progress": 0,
  "created_at": 1784887217,
  "seconds": "5.0",
  "size": "1152x768"
}
```
...
"""
┌─────────────────────────────────────────────────────────────────┐
│  Agnes Video V2.0 文生视频 API 调用示例 - 获取视频                 │
│                                                                 │
...
响应内容:
{
  ...
  "status": "completed",
  "seconds": "5.0",
  "task_id": "task_vMhCiDvALvwYY3sQ4bGdk4xf9SYae2MF",
  "metadata": {
    "url": "https://pl....e2MF.mp4"
  },
  "progress": 100,
  "video_id": "task_vMhCiDvALvwYY3sQ4bGdk4xf9SYae2MF",
  "created_at": 1784887263,
  "completed_at": 1784887311
}

视频链接: https://platform-outputs.agnes-ai.space/videos/agnes-video-v2.0/task_vMhCiDvALvwYY3sQ4bGdk4xf9SYae2MF.mp4
```

<p align="center">
  <small>© 2026 DMXAPI Agnes Video V2.0 文生视频 API 文档</small>
</p>
