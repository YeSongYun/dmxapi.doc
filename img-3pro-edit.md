...
以下示例展示了如何使用 DMXAPI 调用 Gemini 3 Pro Image 模型进行图片编辑：

```python


"""
DMXAPI Gemini 3 Pro Image 图像修改示例
...
3. **分辨率**：支持 1K/2K/4K 分辨率
4. **搜索工具**：支持 Google 搜索工具辅助生成
