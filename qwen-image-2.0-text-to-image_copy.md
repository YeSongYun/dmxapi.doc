...
基于阿里云百炼千问 Qwen-Image-2.0 模型的通用图像生成接口，具备强大的复杂文本渲染能力，支持多行布局与段落级文本生成，可实现精细的图文混合布局设计。支持最高 2048×2048 分辨率输出，提供 5 种推荐宽高比例，单次可批量生成 1-6 张图片，并支持反向提示词控制、提示词智能改写及随机种子复现功能，覆盖多种艺术风格。
