# qwen-image-edit-max-2026-01-16 图片编辑 API文档
...
payload = {
    ...
    # 【model】模型名称。示例值：qwen-image-edit-max。
...
```json
{
  "output": [
    {
      ...
      "content": [
        {
          "type": "image",
          "text": "https://dashscope-result-sh.oss-cn-shanghai.aliyuncs.com/7d/ce/20260227/f3c4f0bb/fe09138b-16e9-4e42-8e38-c6a0618d77fc756765.png?Expires=1772771659&OSSAccessKeyId=LTAI5tKPD3TMqf2Lna1fASuh&Signature=AwCOe2rK5iG88O%2BY%2BmB8bneWPuU%3D"
        },
        {
          "type": "image",
          "text": "https://dashscope-result-sh.oss-cn-shanghai.aliyuncs.com/7d/bf/20260227/f3c4f0bb/715fd126-701d-43a1-a088-06fa30eb8688756766.png?Expires=1772771659&OSSAccessKeyId=LTAI5tKPD3TMqf2Lna1fASuh&Signature=kehlS0Ulxslsyi6np1Wlq430Axk%3D"
        }
      ]
    }
  ],
  ...
  "request_id": "33fd2f49-1af1-4d8f-bbee-8d71ca0ebdbf"
}
```
