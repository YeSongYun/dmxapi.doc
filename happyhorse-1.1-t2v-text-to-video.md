# happyhorse-1.1-t2v 文生视频 API 使用文档

HappyHorse 文生视频 API 基于 happyhorse-1.1-t2v 模型，输入文本提示词即可生成物理真实、运动流畅的视频内容。支持 720P 和 1080P 两种分辨率、9 种宽高比（16:9、9:16、1:1、4:3、3:4、4:5、5:4、9:21、21:9），可自定义视频时长（3–15 秒），并支持水印控制与随机种子固定。接口采用两步异步模式：先提交任务获取任务 ID，再通过任务 ID 查询并获取生成视频。
...
payload = {
    ...
    # 可选值: "happyhorse-1.1-t2v" 
    "model": "happyhorse-1.1-t2v",
    # 【input】(object, 必填) 模型的输入信息
    "input": {
...
```json
{
  "request_id": "2b0c99a9-5e40-9dc2-adae-239b62df4ee9",
  "output": [
    {
      "type": "message",
      "content": [
        {
          "type": "output_text",
          "text": "{\"task_id\":\"ba92fcc3-383f-4d3f-89dc-19160fe37ad0\",\"task_status\":\"PENDING\"}"
        }
      ]
    }
  ],
...
payload = {
    ...
    "input": "ba92fcc3-383f-4d3f-89dc-19160fe37ad0"
}
  ...
  "output": [
    {
      ...
      "content": [
        {
          "type": "output_text",
          "text": "{\"task_id\":\"ba92fcc3-383f-4d3f-89dc-19160fe37ad0\",\"task_status\":\"SUCCEEDED\",\"submit_time\":\"2026-07-06 ...\",\"scheduled_time\":\"2026-07-06 ...\",\"end_time\":\"2026-07-06 ...\",\"video_url\":\"https://dashscope-a717.oss-accelerate.aliyuncs.com/1d/aa/20260706/630c1e98/863....mp4?Expires=...\"}"
        }
      ]
    }
  ],
...
<p align="center">
  <small>© 2026 DMXAPI happyhorse-1.1-t2v 文生视频</small>
</p>
