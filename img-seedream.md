# 火山豆包 即梦 Seedream 文生图 API 文档

> 强大的 AI 文生图服务，支持高质量图像生成

## 📌 概述

火山豆包 Seedream 是一款先进的文生图模型，能够根据文本描述生成高质量的图像。本文档介绍如何通过 DMX API 调用 Seedream 模型进行图像生成。
...
data = {
    ...
    # │  16:9    │  1280x720    │ 宽屏横向                                │
    # │  9:16    │  720x1280    │ 宽屏竖向                                │
    # │  3:2     │  1248x832    │ 35mm 胶片横向                           │
    # │  2:3     │  832x1248    │ 35mm 胶片竖向                           │
    # │  21:9    │  1512x648    │ 超宽屏                                  │
    # └──────────┴────────────────┴─────────────────────────────────────────┘
...
<p align="center">
  <small>© 2025 DMXAPI · 火山豆包即梦文生图服务</small><br>
</p>
