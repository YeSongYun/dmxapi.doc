# 火山豆包 即梦 Seedream 4.5 文生图 API 文档

> 强大的 AI 文生图服务，支持高质量图像生成

## 📌 概述

火山豆包 Seedream 是一款先进的文生图模型，能够根据文本描述生成高质量的图像。本文档介绍如何通过 DMX API 调用 Seedream 4.5 模型进行图像生成。
...
│                                                                 │
│  功能说明：演示如何使用 DMX API 调用豆包 Seedream 4.5 模型生成图像  │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
"""
