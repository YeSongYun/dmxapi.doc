# Gemini 3.1 Flash Lite Image 多图融合
...
- **特点**: 高效图像融合，支持最多 14 张高保真对象图片，10 种宽高比
- **新特性**: 速度最快、成本最低，仅支持 1K 分辨率
...
```python [SDK]
"""
DMXAPI Gemini 3.1 Flash Lite Image 多图融合示例
...
BASE_URL = "https://www.dmxapi.cn"
    ...
    # └──────────────────────────────────────┘
INPUT_IMAGE_PATHS = [
    "output/generated_image_20260702_103512.png",  # 替换为你的图片路径
    "test/example.jpg",
]
...
payload = {
    ...
    "contents": [{
        "parts": [
            {"text": "An office group photo of these people, they are making funny faces."},  # 图片生成提示词
...
```text [SDK]
融合后的图片已保存到 output/fused_image_20260702_105327.png
```
