...
![reset](img/forget-password1.png)

### 2. 点击「忘记密码」

在登录页面，点击右下角的「忘记密码」按钮。

![reset](img/forget-password2.png)

### 3. 输入邮箱并提交

进入「密码重置」页面，输入你要找回的账户邮箱地址，点击「提交」，系统会向该邮箱发送一封重置密码的邮件。

![reset](img/forget-password4.png)

### 4. 打开邮箱中的重置邮件

登录你的邮箱，找到 DMXAPI 官网发来的「Password Reset」邮件并打开。

![reset](img/forget-password5.png)
