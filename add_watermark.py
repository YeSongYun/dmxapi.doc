...
def main() -> None:
    ...
    # 可以根据实际需要修改这个列表
    image_files = [
        'img/claude-code-cc-swtich1.png',
        'img/claude-code-cc-swtich2.png',
        'img/claude-code-cc-swtich3.png',
        'img/claude-code-cc-swtich4.png',
        'img/claude-code-cc-swtich5.png',
        'img/claude-code-cc-swtich6.png',
    ]
